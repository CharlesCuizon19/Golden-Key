<div x-data="inquiryModal()" x-effect="document.body.classList.toggle('overflow-hidden', open)" class="relative z-50">
    ...
    <button @click="open = true">
        <div class="flex items-center gap-3 bg-[#edc45b] hover:bg-[#f4d16e] w-fit transition px-5 py-3 rounded-md cursor-pointer">
    ...
    <template x-teleport="body">
        <div x-show="open" x-transition x-cloak class="fixed inset-0 z-[9999] flex items-center justify-center p-4" aria-modal="true">
            ...
            <!-- Modal box -->
            <div @click.stop x-transition.scale.origin.center class="relative z-10 w-full max-w-2xl max-h-[90%] overflow-y-auto bg-[#101317] text-gray-100 border border-gray-700 rounded-xl shadow-2xl">
                <!-- Header -->
                ...
                <form @submit.prevent="submitInquiry" class="p-6 space-y-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block mb-1 text-lg font-bold text-gray-300">Email Address <span class="text-[#edc45b]">*</span></label>
                        ...
                        <div>
                            <label class="block mb-1 text-lg font-bold text-gray-300">Interested In <span class="text-[#edc45b]">*</span></label>
                    ...
                    <div class="flex items-center gap-3 pt-4 border-t border-gray-700">
                        <button type="submit" class="gap-2 bg-[#ecc467] w-full hover:bg-[#e6b74e] text-black font-medium text-lg px-6 py-3 rounded-md transition">Submit Inquiry</button>
