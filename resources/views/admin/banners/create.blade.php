...
<div class="max-w-screen-xl mx-auto bg-[#121212] p-10 rounded-2xl shadow-xl border border-gray-800">
    <h1 class="text-3xl font-extrabold mb-8 text-[#f37021] tracking-wide">CREATE BANNER</h1>
    ...
    document.getElementById('media').addEventListener('change', function(event) {
        ...
        if (file && file.type.startsWith("image/")) {
            ...
            reader.onload = function(e) {
                ...
                // Float slightly outside the top-right corner
