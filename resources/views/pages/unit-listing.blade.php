                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-20 2xl:grid-cols-3">
                        ...
                        <a href="{{ route('unit-listing.singlepage', ['id' => $item->id]) }}"
                                ...
                                <div class="flex items-center gap-5 text-[#656565]">
                                    <div class="flex flex-wrap gap-4 mt-2">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            @elseif(Str::lower($feature->name) == 'bathrooms')
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-bold 2xl:text-xl">{{ $item->area }} sqm</span>
                                    </div>
                                </div>
                            </div>

                            <div class="text-xl font-semibold text-[#20272D] 2xl:text-3xl group-hover:underline transition duration-700">
                                {{ $item->name }}
                            </div>
                            ...
                            <div class="flex items-center gap-1 mt-4 text-[#656565]">
                                <span class="text-lg font-semibold text-[#CDA23A] 2xl:text-2xl">₱{{ $item->price }}</span>
