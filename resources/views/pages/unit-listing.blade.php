...
@php
    $chunks = collect($properties)->chunk(9);
@endphp
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <div class="flex items-center gap-5 text-[#656565]">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <span
                                                        class="text-sm font-bold 2xl:text-xl">{{ $item->bathrooms }}</span>
                                                </div>
        ...
        function filterBar() {
            return {
                filters: [{
                    ...
                    {
                        name: 'City',
                        options: ['Davao', 'Cebu', 'Manila'],
                        selected: ''
                    },
                    {
                        name: 'Price',
                        options: ['₱0 - ₱1M', '₱1M - ₱5M', '₱5M+'],
                        selected: ''
                    },
                    {
                        name: 'Floor Area',
                        options: ['0 - 50 sqm', '50 - 100 sqm', '100+ sqm'],
                        selected: ''
                    },
                    {
                        name: 'Sort by',
