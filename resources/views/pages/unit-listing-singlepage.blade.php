        ...
        <div class="grid grid-cols-1 gap-6 pb-16 border-b lg:grid-cols-5">
            ...
            <div class="grid grid-cols-2 gap-3 lg:col-span-2">
                ...
                @if ($index < 4)
                    ...
                    <img src="{{ asset($item->image_path) }}" alt="Property Image" class="object-cover w-full h-full rounded-xl">
                ...
                <div class="flex flex-wrap gap-16">
                    <div class="flex flex-wrap gap-16">
                        ...
                        <div class="flex items-center gap-3 text-black/80">
                            {{-- You can assign an icon per feature if needed, for now using a generic icon --}}
        ...
        {{ $property->status === 'for_sale'
            ...
            : ($property->status === 'for_rent'
                ...
                <div class="text-5xl font-bold text-[#cda23a] flex items-center gap-2">
                    ₱ {{ $property->price }} <span class="text-2xl font-thin text-white">/ {{ $property->price_status }}</span>
                </div>
            ...
            <div class="bg-[#f8f8f8] p-4 flex flex-col gap-5 rounded-xl">
                ...
                <div class="flex flex-wrap justify-between w-full p-5 bg-white border rounded-xl">
                    <div class="flex items-center gap-3">
                        <img src="{{ asset($property->agent->image ?? 'images/sample-user.avif') }}" alt="{{ $property->agent->name ?? 'Agent Image' }}"
            ...
            <a href="{{ route('unit-listing.singlepage', ['id' => $item->id]) }}"
                ...
                <div class="relative group">
                    <div class="overflow-hidden rounded-lg">
                        <img
                            src="{{ asset($item->images->first()?->image_path ?? 'images/default-property.jpg') }}"
                            alt="{{ $item->name }}"
                            loading="lazy"
                    ...
                    <div class="absolute top-3 left-3 px-4 py-2 text-sm text-black rounded-lg 2xl:text-base {{ $statusColor }}">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="flex items-center gap-5 text-[#656565]">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            @php
                            $icon = strtolower($feature->feature_name) === 'bedrooms'
                            ? '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <g fill="currentColor">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm font-bold 2xl:text-xl">{{ $item->sqm }}
                                sqm</span>
                        </div>
                    </div>
                </div>
