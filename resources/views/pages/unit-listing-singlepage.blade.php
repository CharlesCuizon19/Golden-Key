...
<div>
            ...
            <div class="lg:col-span-3">
                <div class="flex flex-col gap-5">
                    <div class="relative w-full h-full overflow-hidden rounded-xl">
                        <img src="{{ asset($property->images->first()->image_path ?? '') }}" alt="{{ $property->name }}"
    ...
    get shortDescription() {
        return this.description.split(' ').slice(0, 80).join(' ') + (this.description.split(' ').length > 80 ? '...' : '');
    }
}" class="flex flex-col gap-5">

                <!-- Description -->
                <div class="text-2xl leading-snug text-black/80 transition-all duration-500 ease-in-out">
                    <span x-text="expanded ? description : shortDescription"></span>
                </div>

                <!-- Read More / Read Less -->
                <template x-if="description.split(' ').length > 80">
                    <div @click="expanded = !expanded" class="flex items-center gap-2 cursor-pointer select-none">
                        <div class="text-2xl font-bold text-black/80" x-text="expanded ? 'Read Less' : 'Read More'">Read More</div>
                        <svg :class="expanded ? 'rotate-180' : ''" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="transition-transform duration-300">
                ...
                <div class="flex flex-wrap gap-16">
                    <div class="flex flex-wrap gap-16">
                        ...
                        <div class="flex items-center gap-3 text-black/80">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="size-10" fill="currentColor">
